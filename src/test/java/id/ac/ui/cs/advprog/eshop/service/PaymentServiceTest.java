...
class PaymentServiceTest {
    ...
    void setUp() {
        ...
        Payment payment1 = new Payment("payment-1",
                PaymentMethod.VOUCHER.getValue(), order, paymentData1);
        payments.add(payment1);

        Map<String, String> paymentData2 = new HashMap<>();
        paymentData2.put("bankName", "BCA");
        paymentData2.put("referenceCode", "REF123456");
        Payment payment2 = new Payment("payment-2",
    ...
    void testSetStatusSuccess() {
        ...
        assertEquals(PaymentStatus.SUCCESS.getValue(), result.getStatus());
        verify(orderService, times(1)).updateStatus(order.getId(),
                PaymentStatus.SUCCESS.getValue());
    }
